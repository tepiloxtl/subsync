...
from syncsonic import download
...
def main():
    ...
    download_options.add_argument("--local-library", type=str, help = "For --m3u-only, path for local library")
    download_options.add_argument("--remote-library", type=str, help = "For --m3u-only, path for remote library")
